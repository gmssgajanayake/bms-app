    ...
    return (
        <section className="bg-white">
            <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                <section
                    className="  bg-cover bg-background bg-no-repeat relative bg-gray-900 flex h-32 items-end  lg:col-span-5 lg:h-full xl:col-span-6">
                ...
                >
                    <div className="max-w-xl lg:max-w-3xl">
                        <div className="relative -mt-16 block lg:hidden">
                            <a
                                className="inline-flex size-20 border-4 p-4 border-indigo-100 items-center justify-center rounded-full bg-white text-blue-950  sm:size-20"
                                href="#"
                            >
